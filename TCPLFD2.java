...
public class TCPLFD2 {
    public static final int SERVICE_PORT = 10106;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LFDHeartbeatTask lfdHeartbeatTask = new LFDHeartbeatTask(gfd, "LFD2");
            ...
            try {
                ...
                while(true) {
                    ...
                    if (connect == null) {
                        ...
                        System.out.println("Service 2 connected");
                        OutputStream out = gfd.getOutputStream();
                        out.write(("add replica S2" + TCPService.END_CHAR).getBytes());
                        ScheduledTask2 st = new ScheduledTask2(connect, TCPService2.SERVICE_IP,TCPService2.SERVICE_PORT, gfd); // Instantiate SheduledTask class
